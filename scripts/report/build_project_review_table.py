...
# ★ 第 8 類 —— 只喺【期後】表出現（2.2／2.4），2025年度計劃嗰張冇（所以 1.4 係「七大類」）。
#   scan p21 formula 行 a|1|2|4|5|6|8|b 就係佢：2024 期後個 (32,886) 萬全部行呢一欄，
#   同我哋之前落唔到七大類嘅殘差 32,887 萬對得返（項目組 2026-08-17 問「點解冇 point 8」）。
